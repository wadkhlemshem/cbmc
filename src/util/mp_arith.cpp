...
Function: bitwise_or
 ...
 Purpose: 
 bitwise operations only make sense on native objects, hence the largest object size should be the largest available c++ integer size (currently long long)
...
\*******************************************************************/
mp_integer arith_right_shift(const mp_integer &a, const mp_integer &b,unsigned true_size)
{
...
\*******************************************************************/
mp_integer logic_right_shift(const mp_integer &a, const mp_integer &b,unsigned true_size)
{
  ullong_t shift=b.to_ulong();
  if (shift>true_size) throw "shift value out of range"; 
  ullong_t result=a.to_ulong()>>shift;
...
\*******************************************************************/
mp_integer rotate_right(const mp_integer &a, const mp_integer &b,unsigned true_size)
{
  ullong_t number=a.to_ulong();
  ullong_t shift=b.to_ulong();
  if (shift>true_size) throw "shift value out of range"; 
...
\*******************************************************************/
mp_integer rotate_left(const mp_integer &a, const mp_integer &b,unsigned true_size)
{
  ullong_t number=a.to_ulong();
  ullong_t shift=b.to_ulong();
  if (shift>true_size) throw "shift value out of range"; 
