...
void c_typecheck_baset::typecheck_decl(codet &code)
{
  ...
  {
    error().source_location=code.find_source_location();
    error() << "decl statement expected to have declaration as operand" << eom;
    throw 0;
  }
...
void c_typecheck_baset::typecheck_gcc_switch_case_range(codet &code)
{
  ...
  {
    error().source_location=code.find_source_location();
    error() << "gcc_switch_case_range expected to have three operands" << eom;
    throw 0;
  }
...
void c_typecheck_baset::typecheck_gcc_computed_goto(codet &code)
{
  ...
  {
    error().source_location=code.find_source_location();
    error() << "computed-goto expected to have dereferencing operand" << eom;
    throw 0;
  }
